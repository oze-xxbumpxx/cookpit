# ADR-0022: レビュー記録を監査ログと意思決定インターフェースの二層にする

- Status: Accepted
- Date: 2026-08-11
- 関連 feature: review-readiness

> **2026-09-17 採番訂正**: 本 ADR は当初 `ADR-0017` として作成したが、同番号が
> [ADR-0017: 賞味期限アラートを Web Push（VAPID）+ 日次 Cron で実現する](./ADR-0017-web-push-expiry-alert.md)
> （2026-08-09 採択）と衝突していた。後から採択した本 ADR を `ADR-0022` へ振り直し、
> ファイル名も変更した。2026-09-17 以前の文書・ログに残る「ADR-0017」のうち、
> review-readiness 文脈の記述は本 ADR を指す。
