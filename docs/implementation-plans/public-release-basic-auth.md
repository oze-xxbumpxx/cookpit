...
- 完了条件: 上記ケースすべてが green（実装時点で計 49 ケース。試験計画の MW-01〜MW-23 /
  MW-19b / MW-19c / MW-M01〜MW-M12 に対応）。`vitest run --project node`
...
3. **単体テスト追加** … `apps/web/tests/middleware.node.test.ts` を新規作成し、上記ケース（計 49）を
