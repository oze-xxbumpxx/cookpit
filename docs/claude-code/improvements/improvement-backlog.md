...
| IMP-2026-008 | orchestrator stop/resume 後の Sub-agent notification 待ちループを解消（状態ファイル + 通知非依存の冪等再開 / 単一委譲は同期既定） | .claude/agents/orchestrator.md / docs/claude-code/orchestration-policy.md / .claude/state/inflight-agents.json | proposal | [candidates/store-master.md](candidates/store-master.md)（事象1） | [proposals/IMP-2026-008.md](proposals/IMP-2026-008.md) | 未実施 | 未決定（人間承認必須・IMP-2026-007 採否の前提） |
