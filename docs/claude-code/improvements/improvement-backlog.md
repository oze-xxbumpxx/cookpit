...
| IMP-2026-007 | orchestrator L3 設計フェーズの逐次実行＋重複探索を改善（改善A: 設計系並列化 / 改善B: 先行調査共有） | .claude/agents/orchestrator.md / docs/claude-code/orchestration-policy.md | proposal | [candidates/orchestrator-parallelization.md](candidates/orchestrator-parallelization.md)（**ユーザー指定の必須昇格**） | [proposals/IMP-2026-007.md](proposals/IMP-2026-007.md) | 未実施（agent-evaluator: database-schema-change / aws-integration-change / refactoring） | 未決定（人間承認必須） |
