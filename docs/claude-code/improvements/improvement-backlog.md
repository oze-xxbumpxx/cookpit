...
| IMP-2026-003 | reviewer に障害設計レビュー観点を追加（外部 I/O / 障害系タスク限定で適用） | .claude/agents/reviewer.md | proposal（人間承認待ち） | ベースライン採点（INDEX 弱軸 §3 レビュー品質 3.7） | [proposals/IMP-2026-003.md](proposals/IMP-2026-003.md) | [evaluations/IMP-2026-003.md](evaluations/IMP-2026-003.md) | 人間承認待ち（manager は採用推奨・本適用せず） |
| IMP-2026-004 | contract-designer の起動条件を明示化（L2 の Zod スキーマ変更で必須起動） | docs/claude-code/orchestration-policy.md / .claude/agents/orchestrator.md | proposal（人間承認待ち） | ベースライン採点（INDEX 弱軸 §2 契約品質 3.4）+ [candidates/recipe-edit-screen.md](candidates/recipe-edit-screen.md)（事象5） | [proposals/IMP-2026-004.md](proposals/IMP-2026-004.md) | [evaluations/IMP-2026-004.md](evaluations/IMP-2026-004.md) | 人間承認待ち（manager は採用推奨・本適用せず） |
