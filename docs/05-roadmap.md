...
| ユニット                        | 内容                                                                                                                                           | レベル               | 実装ルート                           | 状態                                                                                                    |
| ------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------- |
| Unit A: meal-plan-sync          | タスク 1（献立変更への削除追随・数量合算）。既存 `POST /api/shopping-lists/:id/sync` の意味を拡張する。ADR-0007 の将来課題を本 Sprint で閉じる | **L3**               | Orchestrator 経路                    | **完了**（PR #162 マージ・2026-08-13）                                                                  |
