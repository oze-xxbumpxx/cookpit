...
import { PriceRecordId } from '../../src/product/price-record-id';
import { PriceRecord, Product } from '../../src/product/product';
import { ProductId } from '../../src/product/product-id';
import type { PriceRecordProps, ProductProps } from '../../src/product/product';
