...
import { CompleteShoppingUseCase } from '../../src/shopping-list/complete-shopping.use-case';
import type { StockAdditionInputDto } from '../../src/shopping-list/shopping-list.dto';
